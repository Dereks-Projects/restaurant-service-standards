 ...
 * The entry point for new customers. Creates both the Supabase
 * auth account AND the organization record in one flow.
 *
 ...
 *
 * SLUG GENERATION:
 * The organization name is converted to a URL-safe slug
 * automatically. "Starr Restaurants" becomes "starr-restaurants".
 * This slug is used in preview URLs: /preview/starr-restaurants
 */
...
export default function SignupPage() {
  ...
  async function handleSignup(e) {
    ...
    if (authError) {
      /* Clean up: remove the org we just created since signup failed */
